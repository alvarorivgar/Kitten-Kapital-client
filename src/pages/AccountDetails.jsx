...
function AccountDetails() {
  ...
  const [isTransactionListShowing, setIsTransactionListShowing] =
    useState(false);
        ...
        <div className="col-md-6 col-sm-6 col-xl-6 col-lg-4 formulario">
                    ...
                    <div id="card-Background" className="card px-4">
                      <div className=" my-3">
                        ...
                        <p className="text-muted ">
                          Coose your credit card, introduce your credentials and
          ...
          <div>
            <div className="formulario">
              <h3
                onClick={() =>
                  setIsTransactionListShowing(!isTransactionListShowing)
                }
              >
                Movements
              </h3>
